...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'sandbox.presets.stackedBoxes': '堆叠方块',
    'sandbox.presets.slopeBall': '斜坡滚球',
    'sandbox.presets.springPendulum': '弹簧摆',
    'sandbox.presets.collision': '双球碰撞',
    'sandbox.presets.newtonCradle': '牛顿摆',
    'sandbox.presets.ramp': '斜面下滑',
    'sandbox.templateSave': '保存为模板',
    'sandbox.templateSaveTitle': '保存场景模板',
    'sandbox.templateNameHint': '输入模板名称...',
    'sandbox.templateDeleteConfirm': '确定要删除模板"{name}"吗？',
    'sandbox.templateDelete': '删除模板',
    'sandbox.templateRename': '重命名',
    'sandbox.templateSaved': '模板已保存',
    'sandbox.myTemplates': '我的模板',
    'sandbox.copy': '复制',
    'sandbox.paste': '粘贴',
    ...
    'sandbox.transform': '变换',
    'sandbox.appearance': '外观',
    'sandbox.titleActions': '操作',
    'sandbox.lockedBadge': '已锁定',
    'sandbox.hiddenBadge': '已隐藏',
    'sandbox.paletteSearch': '搜索器材或预设...',
    'sandbox.paletteNoResults': '无匹配结果',
    'sandbox.tabAll': '全部',
    'sandbox.tabGeometry': '几何',
    'sandbox.tabEquipment': '器材',
    'sandbox.tabPresets': '预设',
    'sandbox.geometryShapes': '几何形状',
    'sandbox.editSelection': '编辑选择',
    'sandbox.snapSelectedToGround': '落地',
    'sandbox.align': '对齐',
    'sandbox.distribute': '等距分布',
    'sandbox.alignMin': '最小边对齐',
    'sandbox.alignCenter': '中心对齐',
    'sandbox.alignMax': '最大边对齐',
    'sandbox.distributeAxis': '{axis}轴等距',
    'sandbox.axisX': 'X',
    'sandbox.axisY': 'Y',
    'sandbox.axisZ': 'Z',
    'sandbox.show': '显示',
    ...
    'sandbox.recording.start': '录制',
    'sandbox.recording.stop': '停止',
    'sandbox.recording.playback': '回放',
    'sandbox.recording.stopPlayback': '停止回放',
    'sandbox.recording.clear': '清除录制',
    'sandbox.recording.export': '导出',
    'sandbox.recording.exportJson': '导出 JSON',
    'sandbox.recording.frames': '{count} 帧',
    'sandbox.recording.limitReached': '录制已达最长时长（30秒），已自动停止',
  ...
  en: {
    ...
    'sandbox.presets.stackedBoxes': 'Stacked Boxes',
    'sandbox.presets.slopeBall': 'Slope Ball',
    'sandbox.presets.springPendulum': 'Spring Pendulum',
    'sandbox.presets.collision': 'Two-Ball Collision',
    'sandbox.presets.newtonCradle': 'Newton Cradle',
    'sandbox.presets.ramp': 'Ramp Slide',
    'sandbox.templateSave': 'Save as Template',
    'sandbox.templateSaveTitle': 'Save Scene Template',
    'sandbox.templateNameHint': 'Enter template name...',
    'sandbox.templateDeleteConfirm': 'Delete template "{name}"?',
    'sandbox.templateDelete': 'Delete Template',
    'sandbox.templateRename': 'Rename',
    'sandbox.templateSaved': 'Template saved',
    'sandbox.myTemplates': 'My Templates',
    'sandbox.copy': 'Copy',
    'sandbox.paste': 'Paste',
    ...
    'sandbox.appearance': 'Appearance',
    'sandbox.titleActions': 'Actions',
    'sandbox.lockedBadge': 'Locked',
    'sandbox.hiddenBadge': 'Hidden',
    'sandbox.paletteSearch': 'Search equipment or presets...',
    'sandbox.paletteNoResults': 'No matches',
    'sandbox.tabAll': 'All',
    'sandbox.tabGeometry': 'Geometry',
    'sandbox.tabEquipment': 'Equipment',
    'sandbox.tabPresets': 'Presets',
    'sandbox.geometryShapes': 'Geometry Shapes',
    'sandbox.editSelection': 'Edit Selection',
    'sandbox.snapSelectedToGround': 'Snap to Ground',
    'sandbox.align': 'Align',
    'sandbox.distribute': 'Distribute',
    'sandbox.alignMin': 'Align Min',
    'sandbox.alignCenter': 'Align Center',
    'sandbox.alignMax': 'Align Max',
    'sandbox.distributeAxis': 'Distribute {axis}',
    'sandbox.axisX': 'X',
    'sandbox.axisY': 'Y',
    'sandbox.axisZ': 'Z',
    'sandbox.show': 'Show',
    ...
    'sandbox.dataResetView': 'Reset View',
    ...
    'sandbox.recording.start': 'Record',
    'sandbox.recording.stop': 'Stop',
    'sandbox.recording.playback': 'Replay',
    'sandbox.recording.stopPlayback': 'Stop Replay',
    'sandbox.recording.clear': 'Clear Recording',
    'sandbox.recording.export': 'Export',
    'sandbox.recording.exportJson': 'Export JSON',
    'sandbox.recording.frames': '{count} frames',
    'sandbox.recording.limitReached': 'Recording limit reached (30s), stopped automatically',
